    ...
    render() {
        return (
            ...
            >
                ...
                <Box sx={{ textAlign: 'center', m: 5 }}>I've been expriencing with research, web development and architecture using Python, JS (React and vanilla), C, C++, JAVA in multiple system such as Windows, Linux, Android and IOS</Box>
                </Typography>
                </Item>
            </Stack>
        );
