...
import {solid, vertical} from './articles.css'
...
<p class="has-small-font-size"><em>Written by Ori Roza, May 18, 2018</em>
</p>
...
<div>
    <hr class={solid}/>
    <IconButton color="primary" onClick={()=> {console.log("click")}} className={vertical}>
        <ExpandMoreIcon />
    </IconButton>
</div>
