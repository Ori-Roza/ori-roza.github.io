...
<pre id="de9e" class="graf graf--pre graf-after--p">In [1]: ps.net_connections?
...
<pre id="4588" class="graf graf--pre graf-after--p">In [1]: def link_connection_to_process():
