    ...
    render() {
        return (
            ...
            >
                ...
                <Box sx={{ textAlign: 'center', m: 1 }}>I've been expriencing with research, web development and architecture</Box>
                <Box sx={{ textAlign: 'center', m: 1 }}>using Python, JS (React and vanilla), C, C++, JAVA in multiple system such as Windows, Linux, Android and IOS</Box>
                </Typography>
                </Item>
            </Stack>
        );
